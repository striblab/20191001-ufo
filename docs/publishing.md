...
```html
<div data-pym-src="https://static.startribune.com/news/projects/all/20190430-ufo">Loading...</div>
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/20190430-ufo/",
      "url": "http://static.startribune.com/news/projects-staging/all/20190430-ufo/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/20190430-ufo/",
      "url": "http://static.startribune.com/news/projects/all/20190430-ufo/"
    }
  }
}
```
